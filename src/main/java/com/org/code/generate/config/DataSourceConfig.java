package com.org.code.generate.config;

import com.org.code.generate.config.converts.MySqlTypeConvert;
import com.org.code.generate.config.converts.OracleTypeConvert;
import com.org.code.generate.config.converts.PostgreSqlTypeConvert;
...
public class DataSourceConfig {
     ...
     * 获取数据库下的所有表名
     */
    public  List<String> getAllTableNamesOnDb() {
        ...
        try {
            ...
            logger.error("getAllTableNamesOnDb failure", e);
        } finally {
            closeConnection();
        }
        return tableNames;
...
//            conn = DriverManager.getConnection(this.url, this.username, this.password);
    ...
    public List<TableInfo> getTablesInfo(String[] tables) {
        ...
        for(int i = 0; i < tables.length; ++i){
            ...
            tableInfo.setFields(getTableFieldsByTableName(tableInfo.getName()));
     ...
     * @return
     */
    private List<TableField> getTableFieldsByTableName(String tableName){
